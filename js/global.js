...
function prepareSlideshow() {
    ...
    preview.setAttribute("alt","hakjhjashdkasjkdh");
...
function preparePlaceholder() {
    ...
    placeholder.setAttribute("alt","hi");
//创建文本描述
    var description = document.createElement("p");
    description.setAttribute("id","description");
    var desctext = document.createTextNode("这些品种你认得吗");
...
function displayAbbreviations() {
    ...
    var header_text = document.createTextNode("abbrkjdksjksl");
